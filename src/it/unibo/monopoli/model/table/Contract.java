...
/**
 * This interface represent all the contracts for each {@link Ownership}.
 * All that contracts declare the name, the cost, the income and 
 * the mortgage value of their own {@link Ownership}.
 *
 */
public interface Contract {

    /**
     * Return the name of this {@link Contract} that is the same of his {@link Ownership}.
