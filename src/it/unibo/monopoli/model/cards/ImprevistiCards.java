...
public enum ImprevistiCards {
    ...
    CARD1("FATE 3 PASSI INDIETRO (CON TANTI AUGURI)", 1, MoveUpTo.takeSteps(-3)),
    ...
    CARD15("AVANZATE FINO ALLA STAZIONE PIÙ VICINA: SE È LIBERA POTETE ACQUISTARLA DALLA BANCA; SE È POSSEDUTA DA UN'ALTRO GIOCATORE, LANCIATE I DADI E PAGATE AL PROPIETARIO 10 VOLTE IL NUMERO USCITO",
