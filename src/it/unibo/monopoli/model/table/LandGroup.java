...
/**
 * This interface represent the {@link Group}s of {@link Land}s.
 * They are different from other {@link Group}s because on these you can build {@link Building}s.
 *
 */
public interface LandGroup { 
     ...
     * @param building - the one to add
     */
    void addBuilding(Building building);

    /**
     * Remove a {@link Building} of this {@link Group}.
     * @param building - the one to remove
     */
