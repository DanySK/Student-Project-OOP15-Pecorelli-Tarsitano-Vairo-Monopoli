...
public class ProvaTabellone {
	...
	public JPanel initialize() {
		...
		*/
		...
		JPanel casella20 = new CardGraphic("Via Verdi",Color.GREEN,10000).build(panel);
		...
		JPanel casella21 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella22 = new CardGraphic("Via Gialli",Color.YELLOW,20000).build(panel);
		...
		JPanel casella23 = new CardGraphic("Via Verdi",Color.GREEN,10000).build(panel);
		...
		JPanel casella24 = new CardGraphic("Via Gialli",Color.YELLOW,20000).build(panel);
		...
		JPanel casella25 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella26 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella27 = new CardGraphic("Via Verdi",Color.GREEN,10000).build(panel);
		...
		JPanel casella28 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella29 = new CardGraphic("Via Verdi",Color.GREEN,10000).build(panel);
		...
		JPanel casella30 = new CardGraphic("Via Verdi",Color.GREEN,10000).build(panel);
		...
		JPanel casella31 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella32 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella33 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella34 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella35 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella36 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella37 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella38 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella39 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella0 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella1 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella2 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella3 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella4 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella5 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella6 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella7 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella8 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
		...
		JPanel casella9 = new CardGraphic("Via Rossi",Color.RED,15000).build(panel);
