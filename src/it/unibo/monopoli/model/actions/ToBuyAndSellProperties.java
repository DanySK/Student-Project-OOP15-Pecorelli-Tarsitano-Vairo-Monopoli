...
/**
 * This abstract class represent the common contract of classes {@link ToBuyProperties} and {@link ToSellProperties}.
 *
 */
public abstract class ToBuyAndSellProperties implements Action {
     ...
     */
    protected ToBuyAndSellProperties(final int amount, final Ownership ownership) {
        this.amount = amount;
     ...
     */
    protected ToBuyAndSellProperties(final int amount, final Land land, final Building building) {
        this.amount = amount;
        this.ownership = land;
